export default function MenuBar() {
    ...
    return (
        ...
        <div className="container">
          ...
          <a href="https://www.yourvirtualofficelondon.co.uk/pricing" className="navlink w-nav-link">Pricing</a>
              ...
              <div className="w-row">
                ...
                <div className="nopad w-col w-col-3 w-col-medium-6 w-col-small-small-stack">
                  ...
                  <a href="https://www.yourvirtualofficelondon.co.uk/services/voicemail-service"
                    className="dropdown-link w-dropdown-link">Voicemail Only Service</a>
                  <a href="https://www.yourvirtualofficelondon.co.uk/services/call-answering-service"
                    className="dropdown-link w-dropdown-link">Call Answering Service</a>
                  ...
                  <a href="https://www.yourvirtualofficelondon.co.uk/services/virtual-office-service"
                    className="dropdown-link w-dropdown-link">Complete Virtual Office</a>
                </div>
                <div className="nopad w-col w-col-3 w-col-medium-6 w-col-small-small-stack">
                  ...
                  <a href="https://www.yourvirtualofficelondon.co.uk/services/online-limited-company-formation"
                    className="dropdown-link w-dropdown-link">Limited Company Formation</a>
                  <a href="https://www.yourvirtualofficelondon.co.uk/services/llp-company-formation-service"
                    className="dropdown-link w-dropdown-link">LLP Company Formation</a>
                  <a href="https://www.yourvirtualofficelondon.co.uk/services/ltd-by-guatrantee-company-formation"
                    className="dropdown-link w-dropdown-link">Ltd By Guarantee Company Formation</a>
                </div>
                <div className="nopad w-col w-col-3 w-col-medium-6 w-col-small-small-stack">
                  ...
                  <a href="https://www.yourvirtualofficelondon.co.uk/services/meeting-room-hire-london"
                    className="dropdown-link w-dropdown-link">Meeting Room Hire London</a>
                  <a href="https://www.yourvirtualofficelondon.co.uk/services/business-accounting-service"
                    className="dropdown-link w-dropdown-link">Business Accounting</a>
                  <a href="https://www.yourvirtualofficelondon.co.uk/services/get-a-uk-business-bank-account"
                    className="dropdown-link w-dropdown-link">Free Business Banking</a>
                  <a href="https://www.yourvirtualofficelondon.co.uk/services/uk-business-website-design"
                    className="dropdown-link w-dropdown-link">UK Business Webdesign</a>
                </div>
              </div>
            </nav>
          </div>
          ...
          <a href="https://www.yourvirtualofficelondon.co.uk/resource-centre" className="navlink w-nav-link">Resource
            Centre</a>
